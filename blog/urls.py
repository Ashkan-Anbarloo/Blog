...
urlpatterns = [
    ...
    path('password-change/' , auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('blog:password_change_done')) , name='password_change'),
    ...
    path('page_account' , views.page_account , name='page_account')
]
